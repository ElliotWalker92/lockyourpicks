...
export const metadata = { title: 'League · Lock Your Picks' };
  ...
  return (
    <div className="flex flex-col gap-10">
      <div>
        ...
        <p className="mt-2 flex flex-wrap items-center gap-x-3 gap-y-1 text-neutral-600 dark:text-neutral-400">
          <span>
          ...
          <span>
            Join code{' '}
            <span className="font-mono tracking-widest text-neutral-900 dark:text-neutral-100">
              {league.join_code}
            </span>
          </span>
        </p>
                  ...
                  <ul className="flex flex-col gap-2">
                    {roster.map((dm) => (
                      ...
                      >
                        <span
                          aria-hidden
                          className="flex h-6 w-6 items-center justify-center rounded-full text-xs font-semibold text-neutral-900"
